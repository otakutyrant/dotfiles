...
def lmp3 [filename: string] {
    ...
    let duration = (
        ffprobe $"($filename)" -v error -show_entries format=duration -of default=noprint_wrappers=1:nokey=1 | str trim | into int | into duration --unit sec
    )
